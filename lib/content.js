...
// Only the 11 platforms LLMnesia actually supports get a platform-named CTA.
// Unsupported platforms we still publish SEO guides for (Character.AI, Meta AI,
// Poe, NotebookLM) are deliberately omitted, so the CTA never claims LLMnesia can
