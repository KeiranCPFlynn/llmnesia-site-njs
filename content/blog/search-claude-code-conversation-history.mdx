...
description: "Claude Code splits your history across the terminal, VS Code, and the desktop app. Here is where sessions are stored, how to search them, and a faster way to search every one by keyword."
