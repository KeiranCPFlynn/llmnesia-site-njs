...
Methods 1 and 2 make you either remember the project or wade through raw files. [LLMnesia](https://www.llmnesia.com/) removes both problems: it indexes your Claude Code sessions locally and makes them searchable by keyword from one box — no matter which project or which day they came from.
