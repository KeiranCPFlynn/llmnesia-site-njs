...
Retention also differs substantially across assistants. For example, Microsoft documents an 18-month consumer Copilot history window, while Claude's current retrieval options vary by plan and Project scope. See the [Microsoft Copilot conversation history guide](/blog/microsoft-copilot-conversation-history-guide) and [how to find old Claude conversations](/blog/how-to-find-old-claude-conversations) for those platform-specific rules.
