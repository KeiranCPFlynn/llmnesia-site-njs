---
title: "How to Search Perplexity Chat History and Threads"
slug: "search-perplexity-conversation-history"
description: "Find saved Perplexity Threads through Library, browser history, in-thread search, or a private full-text index across every conversation."
...
**Open Perplexity's Library first when you need an old conversation.** Signed-in searches are saved as Threads, and Library helps you reopen them. If Library does not surface the words you remember from inside an answer, open likely Threads and use browser find, check browser history, or search a local full-text index. LLMnesia indexes visited Perplexity Threads locally and searches them alongside ChatGPT, Claude, Gemini, and other supported platforms.
...
## How to search Perplexity conversation history

The Library is the starting point for saved Threads. The methods below cover increasingly broad searches when its visible titles and filters are not enough.
