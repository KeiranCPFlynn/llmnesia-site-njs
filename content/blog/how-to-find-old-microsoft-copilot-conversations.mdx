---
title: "How to Find Old Microsoft Copilot Conversations"
slug: "how-to-find-old-microsoft-copilot-conversations"
description: "Find an old Microsoft Copilot conversation from the history sidebar, account activity, browser history, or a local full-text index."
...
faq:
  - question: "Does Microsoft Copilot save chat history?"
    answer: "Yes. Microsoft says consumer Copilot retains the last 18 months of interactions when you are signed in. Microsoft 365 Copilot follows separate organisational controls."
...
**To find an old Microsoft Copilot conversation, sign in with the same account and open the conversation list on the left side of copilot.com or the Copilot app.** Microsoft retains the last 18 months of consumer Copilot interactions. If the chat is not visible, check the account, date, browser history, and Microsoft account activity before treating it as deleted.
