---
title: "Export Grok Chat History, Step by Step"
slug: "how-to-export-grok-conversation-history"
description: "Export your Grok conversations to a file you can keep. Follow the steps to save any chat, plus a free way to back up every future one automatically."
...
howto:
  name: "How to export your Grok conversation history"
  steps:
    - name: "Open X account settings and go to Download an archive of you"
      text: "Open X account settings and go to Download an archive of your data."
    - name: "Confirm your identity with the verification code X sends you"
      text: "Confirm your identity with the verification code X sends you."
    - name: "Request the download and wait for X to prepare it"
      text: "Request the download and wait for X to prepare it, up to 24 hours."
    - name: "Download and extract the archive"
      text: "Download and extract the archive."
    - name: "Search the extracted files for grok to find your conversatio"
      text: "Search the extracted files for grok to find your conversation data."
---
