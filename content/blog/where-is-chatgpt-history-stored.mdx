...
[LLMnesia](https://www.llmnesia.com/) is a free, local-first Chrome extension that indexes your ChatGPT conversations on your device as you browse them, and makes them full-text searchable. This flips the storage model: instead of your history living only on OpenAI's servers, a searchable copy also lives on your machine.
