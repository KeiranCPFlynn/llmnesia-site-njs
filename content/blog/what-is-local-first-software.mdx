...
[LLMnesia](https://llmnesia.com/) is a concrete example of local-first design applied to AI chat. It is a free Chrome extension that indexes your conversations across ChatGPT, Claude, Gemini, Perplexity, and other platforms as you browse them, then lets you search the full text from one place.
