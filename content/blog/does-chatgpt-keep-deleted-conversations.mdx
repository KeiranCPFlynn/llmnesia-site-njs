---
title: "Does ChatGPT Keep Deleted Conversations? 2026 Retention Rules"
slug: "does-chatgpt-keep-deleted-conversations"
description: "Yes, briefly: deleted ChatGPT chats are normally scheduled for permanent deletion within 30 days. See the exceptions and why that does not mean recovery."
...
From the user's perspective, the chat is gone. You cannot read it, search it, or restore it. If recovery or verification is what you are after, see [how to recover a deleted ChatGPT chat](https://www.llmnesia.com/blog/recover-deleted-chatgpt-conversation) for practical checks. Those checks can find a chat that was never deleted or a copy that already existed; they cannot retrieve a confirmed deletion from OpenAI.
...
## Related ChatGPT history guides

If a chat vanished without a confirmed deletion, [troubleshoot a disappeared ChatGPT conversation](/blog/chatgpt-conversation-disappeared) before treating it as lost.
