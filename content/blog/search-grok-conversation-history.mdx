---
title: "How to Search Grok Conversation History by Full Text"
slug: "search-grok-conversation-history"
description: "Need one answer buried in an old Grok chat? Compare sidebar, browser-history, export, and private full-text search methods step by step."
...
relatedSlugs:
  - "grok-conversation-history-limits"
...
This page is specifically about **searching inside conversation content**. For retention rules, use [Grok conversation history limits](/blog/grok-conversation-history-limits); for a downloadable copy, use the [Grok export guide](/blog/how-to-export-grok-conversation-history).
