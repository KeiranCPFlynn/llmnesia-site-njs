---
title: "Find Old Perplexity Conversations Fast"
slug: "how-to-find-old-perplexity-conversations"
description: "Cannot find an old Perplexity chat? See exactly where past conversations hide and how to search them in seconds, even across hundreds of chats."
...
**Your old Perplexity conversations are almost never gone, just hard to surface.** Every past chat still lives in Perplexity's history, so the real problem is weak built-in search, not lost data. Below is exactly where to look, plus how to search the full text of every conversation in seconds.
...
## Perplexity AI Chat History Feature: What You Need to Know

Perplexity’s chat history feature, called Library, stores all your past conversations. You can scroll through threads, rename them, and use the search bar to find specific chats. Note that history is stored in your browser, so it may differ between devices unless you have Perplexity Pro.
