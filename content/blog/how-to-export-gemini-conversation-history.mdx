---
title: "Export Gemini Chat History, Step by Step"
slug: "how-to-export-gemini-conversation-history"
description: "Export your Gemini conversations to a file you can keep. Follow the steps to save any chat, plus a free way to back up every future one automatically."
...
howto:
  name: "How to export your Gemini conversation history"
  steps:
    - name: "Go to takeout"
      text: "Go to takeout.google.com and sign in."
    - name: "Click Deselect all"
      text: "Click Deselect all, then check the box for Gemini Apps."
    - name: "Click Next step and choose delivery by email"
      text: "Click Next step and choose delivery by email."
    - name: "Choose Export once and the zip file type"
      text: "Choose Export once and the zip file type."
    - name: "Click Create export"
      text: "Click Create export, then download the link Google emails you."
---
