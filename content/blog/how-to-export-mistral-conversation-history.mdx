---
title: "How to Export Your Mistral (Le Chat) Conversation History"
slug: "how-to-export-mistral-conversation-history"
description: "Le Chat, Mistral's AI assistant, doesn't offer a built-in conversation export. This guide covers every option for saving your Mistral conversation history, how Mistral's API differs from Le Chat, and how to set up ongoing capture so you don't lose access to important exchanges."
...
sources:
  ...
  - label: "Search Mistral conversation history"
    url: "https://llmnesia.com/blog/search-mistral-conversation-history"
