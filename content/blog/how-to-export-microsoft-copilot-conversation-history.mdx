---
title: "Export Copilot Chat History, Step by Step"
slug: "how-to-export-microsoft-copilot-conversation-history"
description: "Export your Copilot conversations to a file you can keep. Follow the steps to save any chat, plus a free way to back up every future one automatically."
...
howto:
  name: "How to export a Microsoft Copilot conversation to PDF"
  steps:
    - name: "Open the Copilot conversation in your browser"
      text: "Open the Copilot conversation in your browser."
    - name: "Press Ctrl+P on Windows or Cmd+P on Mac to open the print di"
      text: "Press Ctrl+P on Windows or Cmd+P on Mac to open the print dialog."
    - name: "Set the destination to Save as PDF"
      text: "Set the destination to Save as PDF."
    - name: "Turn on background graphics and adjust margins if needed"
      text: "Turn on background graphics and adjust margins if needed."
    - name: "Click Save and give the file a clear name"
      text: "Click Save and give the file a clear name."
---
...
## How to Save a Copilot Chat as a PDF

To save a Copilot chat as a PDF, open the chat, click the three‑dot menu, select Print, and in the print dialog choose Save as PDF as the destination. This exports the full conversation as a PDF file.
...
## How to Print a Microsoft Copilot Conversation

Copilot doesn't have a built-in print button, but you can print any conversation using your browser:

1. **Open the conversation** you want to print in Microsoft Copilot (copilot.microsoft.com or within Microsoft 365).
2. **Select all text** in the chat (Ctrl+A or Cmd+A), or manually highlight the conversation.
3. **Copy the text** (Ctrl+C or Cmd+C) and paste it into a Word document or Google Doc for formatted printing.
4. Alternatively, use **browser print** (Ctrl+P or Cmd+P) directly on the Copilot page — the conversation will render as a printable document, though formatting may vary.
5. For a cleaner result, use your browser's **Reader Mode** (if available) before printing to strip navigation and sidebars.

> **Tip:** If you need to save and search your Copilot conversations later (not just print them), [LLMnesia](/) indexes all your Copilot chats locally so you can find any conversation instantly.
