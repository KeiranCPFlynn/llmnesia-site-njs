...
description: "Learn how Claude Artifacts relate to conversation history, how to find their parent chats, and which content LLMnesia can currently index."
...
faq:
  ...
  - question: "Can I search for a specific Claude Artifact?"
    answer: "LLMnesia searches the Claude conversation text it captures and links you back to the original chat. It does not reliably index separate Artifact contents or versions, so open the Artifact in Claude or use a copy you exported when you need its full content."
sources:
...
**4. Index the Parent Conversation**
**LLMnesia** indexes the Claude conversation text it captures locally and links search results back to the original chat. This can help you find a discussion about an Artifact, including code that appears in the captured conversation text. It does not reliably capture the contents of a separate Artifact panel or its versions. If you need the Artifact itself, open it in Claude or keep an exported copy.
...
| Third-party indexing | Conversation text can be indexed; separate Artifact contents may be missed | Possible via conversation indexing |
