...
Methods 1–3 all ask you to either remember the project or sift through raw files. [LLMnesia](https://llmnesia.com/) removes both steps: it indexes your Claude Code sessions locally and makes every one of them searchable by keyword — across every project, from one box.
