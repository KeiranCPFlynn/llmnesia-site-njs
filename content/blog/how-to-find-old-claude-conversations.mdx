---
title: "Find Old Claude Conversations Fast"
slug: "how-to-find-old-claude-conversations"
description: "Cannot find an old Claude chat? See exactly where past conversations hide and how to search them in seconds, even across hundreds of chats."
...
**Your old Claude conversations are almost never gone, just hard to surface.** Every past chat still lives in Claude's history, so the real problem is weak built-in search, not lost data. Below is exactly where to look, plus how to search the full text of every conversation in seconds.
