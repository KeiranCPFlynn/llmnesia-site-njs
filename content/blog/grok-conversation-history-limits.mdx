---
title: "Grok Conversation History Limits: Retention, Search & Export"
slug: "grok-conversation-history-limits"
description: "Grok publishes no fixed chat-retention limit. See what is saved, what account loss changes, and where to search, export, or back up conversations."
...
## Pick the Grok history answer you need

| Your question | Best page |
|---|---|
| How long does Grok keep chats? | Stay on this page |
| Where did an old Grok conversation go? | [Find old Grok conversations](/blog/how-to-find-old-grok-conversations) |
| How can I search inside every Grok chat? | [Search Grok conversation history](/blog/search-grok-conversation-history) |
| How do I download a copy? | [Export Grok conversation history](/blog/how-to-export-grok-conversation-history) |

Keeping these jobs separate matters: retention, retrieval, full-text search, and export are different problems even though people often search for all four as “Grok history.”
