---
title: "AI Conversation History Limits Compared: ChatGPT, Claude, Gemini, Perplexity & More (2025)"
slug: "ai-conversation-history-limits-compared"
description: "See exactly how long ChatGPT, Claude, Gemini, Perplexity, Grok, DeepSeek, and 8+ other AI tools save your chat history — and how to search it all privately with LLMnesia."
...
If you're wondering [why chatbots forget](/blog/why-ai-chatbots-dont-remember-conversations), we've covered that too.
...
**Context window:** Claude's context window is among the largest available (up to 200k tokens). Extremely long single-session conversations are possible.
...
For more detail, see our full breakdown of [Grok's conversation history and retention policy](/blog/grok-conversation-history-limits) and [whether Grok trains on your data](/blog/does-grok-train-on-your-conversations).

→ [Full guide: Grok conversation history limits, retention & X archive](/blog/grok-conversation-history-limits)
