...
[LLMnesia](https://www.llmnesia.com/) is a free, local-first Chrome extension that indexes Kimi conversations at kimi.ai as you browse them. It builds a full-text searchable index on your device, so you can find a conversation by any word inside it, not just its title.
