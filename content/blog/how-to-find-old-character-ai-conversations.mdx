---
title: "How to Find Old Character.AI Conversations (2026)"
slug: "how-to-find-old-character-ai-conversations"
description: "Find old Character.AI chats by character, browser history, account export, or full-text search—even when you cannot remember which character you used."
...
**Start with the character, not a global chat list.** Character.AI organises history around each character, so an old conversation can be present even when it is hard to surface. If you cannot remember the character, browser history, a data export, or a local full-text index gives you a wider search path.
