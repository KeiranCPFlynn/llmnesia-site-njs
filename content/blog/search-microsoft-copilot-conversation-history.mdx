---
title: "How to Search Microsoft Copilot Chat History"
slug: "search-microsoft-copilot-conversation-history"
description: "Find and search Microsoft Copilot chat history, understand its 18-month retention window, and search conversation text locally."
...
faq:
  - question: "Does Microsoft Copilot save conversation history?"
    answer: "Yes. When you are signed in, the consumer Copilot experience saves conversation history and Microsoft says it retains the last 18 months of interactions. Microsoft 365 Copilot uses separate organisational controls."
  ...
  - question: "Why did my Copilot conversation history disappear?"
    answer: "First confirm that you are signed into the same account and open the conversation sidebar. Consumer Copilot retains the last 18 months, so an older chat may have aged out. Work or school accounts can also follow organisational retention policies."
...
**To find Microsoft Copilot chat history, sign in and open the conversation list on the left side of copilot.com or the Copilot app.** Microsoft says consumer Copilot retains the last 18 months of interactions. The history list lets you reopen a known chat, but for keyword retrieval across conversation text you may still need to open likely chats, use browser history, or search a local index.

Microsoft Copilot is several products under one brand, so the exact history controls depend on whether you use consumer Copilot, the desktop or mobile app, or Microsoft 365 Copilot.
...
- Consumer Copilot retains the last 18 months of interactions, according to Microsoft
