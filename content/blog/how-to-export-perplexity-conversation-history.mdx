---
title: "Export Perplexity Chat History, Step by Step"
slug: "how-to-export-perplexity-conversation-history"
description: "Export your Perplexity conversations to a file you can keep. Follow the steps to save any chat, plus a free way to back up every future one automatically."
...
howto:
  name: "How to export a Perplexity thread to a document"
  steps:
    - name: "Open the thread in your Perplexity Library"
      text: "Open the thread in your Perplexity Library."
    - name: "Select the questions"
      text: "Select the questions, answers, and citation links you want to keep."
    - name: "Copy the selected content"
      text: "Copy the selected content."
    - name: "Paste it into a document such as Google Docs"
      text: "Paste it into a document such as Google Docs, Notion, or a text file."
    - name: "Save the file with the topic and date in the name"
      text: "Save the file with the topic and date in the name."
---
