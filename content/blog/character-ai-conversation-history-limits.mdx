...
faq:
  ...
  - question: "Can I search inside my Character.AI conversation history?"
    answer: "Not by content, natively. Character.AI does not provide full-text search across your chats. You can browse by character, use Ctrl+F within an open conversation, and search exported or copied transcripts locally. LLMnesia does not currently support Character.AI."
...
### Build a searchable archive manually

LLMnesia does not currently support Character.AI, so the workaround is manual archiving. Use Character.AI's data export when available, and copy irreplaceable threads into a local document or notes app. That gives you normal full-text search across the saved material even though Character.AI itself does not provide it.

If you also use ChatGPT, Claude, Gemini, Perplexity, Grok, or other supported platforms alongside Character.AI, [LLMnesia](https://llmnesia.com/) can cover that part of your AI workflow. It just will not search Character.AI chats today.
