...
faq:
  ...
  - question: "Can I search inside my Character.AI conversation history?"
    answer: "Not by content natively — Character.AI does not provide full-text search across your chats. LLMnesia adds it: it now supports Character.AI, indexes your conversations locally in your browser, and backfills your existing history so you can search every character and session by keyword from one place."
...
### Add full-text search with LLMnesia

The lack of content search is the limit [LLMnesia](https://llmnesia.com/) solves directly. It now supports Character.AI: once installed, it indexes your conversations locally in your browser and backfills your existing history, so every character and session becomes searchable by keyword — not just the chats you open from now on. No manual export, no copying threads into a notes app.

Because LLMnesia also covers ChatGPT, Claude, Gemini, Perplexity, Grok, and your other AI tools, one search box spans your whole AI history — the roleplay and stories in Character.AI alongside everything else. It all stays on your device.
