...
faq:
  ...
  - question: "Can I search my Pi conversation history?"
    answer: "Pi does not offer a native full-text search of conversation history. You can scroll through your conversation thread, use browser find-in-page on loaded text, request a data export, and search that export locally. LLMnesia does not currently support Pi.ai."
  ...
  - question: "Does LLMnesia support Pi?"
    answer: "LLMnesia does not currently support Pi.ai. If you also use platforms LLMnesia does cover — ChatGPT, Claude, Gemini, Perplexity, Grok, and others — it indexes those conversations and gives you cross-platform search from a single index."
sources:
  - label: "Pi.ai"
    url: "https://pi.ai/"
  - label: "Inflection AI"
