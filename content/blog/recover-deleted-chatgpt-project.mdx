---
title: "Recover a Deleted ChatGPT Project: What to Try"
slug: "recover-deleted-chatgpt-project"
description: "Deleted a ChatGPT project? See what can still be restored, where its chats may survive, and how to back them up before it happens again."
...
**A deleted ChatGPT project may not be fully gone yet, especially if you just removed it.** Check your recently closed tabs and browser history first, since project chats can linger in cache for a short window. Beyond that, restoring depends on an export or local backup made beforehand, so automatic backups are the reliable safeguard.
...
If LLMnesia was installed and had indexed conversations within the project before deletion, the content is still in your local index — and you don't have to dig through raw data to read it. Search for it and click the result: if the original is gone because the project was deleted, LLMnesia takes you straight to your saved copy instead of a dead link, with a note explaining why up front. The copy is formatted like the real conversation, with your search terms highlighted and a one-click "Copy transcript" button.
...
3. Click through — if the conversations were indexed, you land on a clean, readable copy from your local store, not a dead link
