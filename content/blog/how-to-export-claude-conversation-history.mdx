---
title: "Export Claude Chat History, Step by Step"
slug: "how-to-export-claude-conversation-history"
description: "Export your Claude conversations to a file you can keep. Follow the steps to save any chat, plus a free way to back up every future one automatically."
...
LLMnesia does not currently import Claude's downloaded export ZIP. Keep the export as a separate backup. LLMnesia's "Import older chats" feature reads your Claude history through your signed-in browser session.

If you're using LLMnesia for ongoing indexing of Claude conversations:

- The LLMnesia index covers Claude conversations it has captured, including older chats indexed through "Import older chats"
...
Use the export as a portable archive and LLMnesia to search the Claude conversation text it captures. Separate Artifacts and other rich-content blocks may not be included in LLMnesia's saved transcript.
