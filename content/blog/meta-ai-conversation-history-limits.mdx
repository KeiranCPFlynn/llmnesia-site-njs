...
[LLMnesia](https://www.llmnesia.com/) is a free, local-first Chrome extension that indexes your AI conversations locally and makes them full-text searchable across ChatGPT, Claude, Gemini, Perplexity, Grok, Meta AI, and more. It supports conversations on meta.ai, including older chats that Meta AI exposes in its sidebar. It does not cover Meta AI inside WhatsApp, Instagram, or Facebook. For a broader comparison of how different platforms handle history limits, see [AI conversation history limits compared](/blog/ai-conversation-history-limits-compared).
