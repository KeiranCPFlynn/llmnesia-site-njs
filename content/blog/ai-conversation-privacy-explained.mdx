...
[LLMnesia](https://www.llmnesia.com/) is a local-first Chrome extension that indexes AI conversations on your device — across ChatGPT, Claude, Gemini, Perplexity, DeepSeek, and others — and gives you full-text search across them.
