...
[LLMnesia](https://llmnesia.com/) is a free, local-first Chrome extension that indexes Qwen conversations at chat.qwen.ai as you browse them. It builds a full-text searchable index on your device, so you can find a conversation by any word inside it, not just its title.
