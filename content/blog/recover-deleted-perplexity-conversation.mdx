---
title: "Recover a Deleted Perplexity Thread"
slug: "recover-deleted-perplexity-conversation"
description: "Lost a Perplexity thread? Here is what to try before it is gone for good, and a free way to keep a searchable copy of every conversation."
...
**You have a few real shots at recovering a deleted Perplexity conversation, and they work best in the first minute.** Press your browser's back button or reopen the last closed tab right away, since a cached copy often survives briefly after deletion. For older chats, recovery depends on a backup you already had, which is why an automatic local copy is the only dependable long-term fix.
...
If LLMnesia was installed and had indexed the thread before it was deleted, the content is still in your local index — and you don't have to dig through raw data to read it back. Search for it and click the result: if the original is gone from Perplexity, LLMnesia takes you straight to your saved copy instead of a dead link, with a note explaining why up front. The copy is formatted like the real conversation, with your search terms highlighted and a one-click "Copy transcript" button.
...
3. Click through — if the thread was indexed, you land on a clean, readable copy from your local store, not a dead link
