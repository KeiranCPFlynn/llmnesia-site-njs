...
Claude now takes a different approach on paid plans: you can ask it to retrieve context from past chats, with searches scoped differently inside and outside Projects. See [how Claude past-chat search works](/blog/search-claude-conversation-history).
