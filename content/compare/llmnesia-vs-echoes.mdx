...
faq:
  ...
  - question: "Can I run both at once?"
    answer: "You can, but they overlap on search, so most people pick one. Run Echoes if you want labels, AI summaries, and bulk export in one place and the 50-query monthly limit suits you. Run LLMnesia if you want free, unmetered, search-first retrieval that indexes automatically and gets out of the way."
sources:
...
| Search type | Full-text with fuzzy, boolean, and an AI assistant | Full-text, search-first |
...
| Price | Free tier capped at 50 AI queries/month; paid Plus and Lifetime above | Free, unmetered |
