...
export function GET() {
  ...
  const lines = [
    ...
    `> ${platformListSentence()} — locally in your browser. No account or cloud service is required.`,
    `> Search old prompts, answers, and decisions instantly.`,
    `> Optional Vault adds end-to-end encrypted cross-device sync, backup, restore, and an installable web app beta for search and reading.`,
    `> The web app beta includes Ask Vault, which answers questions across the synced archive and links back to source conversations.`,
    '',
    `Canonical: ${SITE_URL}`,
